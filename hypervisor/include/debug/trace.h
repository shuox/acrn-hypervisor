...
#define TRACE_VMEXIT_CFS_RUNTIME	(0x11000U+ 0x0000001U)
#define TRACE_VMEXIT_CFS_NEW_TIMER1	(0x11000U+ 0x0000002U)
#define TRACE_VMEXIT_CFS_NEW_TIMER2	(0x11000U+ 0x0000003U)
#define TRACE_VMEXIT_CFS_TIMER		(0x11000U+ 0x0000004U)
#define TRACE_VMEXIT_CFS_SECNEXT	(0x11000U+ 0x0000005U)
#define TRACE_VMEXIT_CFS_OBJ_VRUNTIME	(0x11000U+ 0x0000006U)
