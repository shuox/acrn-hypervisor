...
*/
CTASSERT(BOOT_CTX_CR0_OFFSET       == offsetof(struct acrn_regs, cr0));
CTASSERT(BOOT_CTX_CR3_OFFSET       == offsetof(struct acrn_regs, cr3));
CTASSERT(BOOT_CTX_CR4_OFFSET       == offsetof(struct acrn_regs, cr4));
CTASSERT(BOOT_CTX_IDT_OFFSET       == offsetof(struct acrn_regs, idt));
CTASSERT(BOOT_CTX_GDT_OFFSET       == offsetof(struct acrn_regs, gdt));
CTASSERT(BOOT_CTX_LDT_SEL_OFFSET   == offsetof(struct acrn_regs, ldt_sel));
CTASSERT(BOOT_CTX_TR_SEL_OFFSET    == offsetof(struct acrn_regs, tr_sel));
CTASSERT(BOOT_CTX_CS_SEL_OFFSET    == offsetof(struct acrn_regs, cs_sel));
CTASSERT(BOOT_CTX_SS_SEL_OFFSET    == offsetof(struct acrn_regs, ss_sel));
CTASSERT(BOOT_CTX_DS_SEL_OFFSET    == offsetof(struct acrn_regs, ds_sel));
CTASSERT(BOOT_CTX_ES_SEL_OFFSET    == offsetof(struct acrn_regs, es_sel));
CTASSERT(BOOT_CTX_FS_SEL_OFFSET    == offsetof(struct acrn_regs, fs_sel));
CTASSERT(BOOT_CTX_GS_SEL_OFFSET    == offsetof(struct acrn_regs, gs_sel));
CTASSERT(BOOT_CTX_CS_AR_OFFSET     == offsetof(struct acrn_regs, cs_ar));
CTASSERT(BOOT_CTX_EFER_LOW_OFFSET  == offsetof(struct acrn_regs, ia32_efer));
CTASSERT(BOOT_CTX_EFER_HIGH_OFFSET == offsetof(struct acrn_regs, ia32_efer) + 4);
