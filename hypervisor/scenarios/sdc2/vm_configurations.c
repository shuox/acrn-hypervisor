...
struct acrn_vm_config vm_configs[CONFIG_MAX_VM_NUM] = {
	...
	},
	{
		.load_order = POST_LAUNCHED_VM,
		.uuid = {0x38U, 0x15U, 0x88U, 0x21U, 0x52U, 0x08U, 0x40U, 0x05U,	\
			 0xb7U, 0x2aU, 0x8aU, 0x60U, 0x9eU, 0x41U, 0x90U, 0xd4U},
			/* 38158821-5208-4005-b72a-8a609e4190d0 */
		.vcpu_num = 4U,
	...
	},
	{
		.load_order = POST_LAUNCHED_VM,
		.uuid = {0x38U, 0x15U, 0x88U, 0x21U, 0x52U, 0x08U, 0x40U, 0x05U,	\
			 0xb7U, 0x2aU, 0x8aU, 0x60U, 0x9eU, 0x41U, 0x90U, 0xd5U},
			/* 38158821-5208-4005-b72a-8a609e4190d0 */
		.vcpu_num = 4U,
	...
	},
	{
		.load_order = POST_LAUNCHED_VM,
		.uuid = {0x38U, 0x15U, 0x88U, 0x21U, 0x52U, 0x08U, 0x40U, 0x05U,	\
			 0xb7U, 0x2aU, 0x8aU, 0x60U, 0x9eU, 0x41U, 0x90U, 0xd6U},
			/* 38158821-5208-4005-b72a-8a609e4190d0 */
		.vcpu_num = 4U,
	...
	},
	{
		.load_order = POST_LAUNCHED_VM,
		.uuid = {0x38U, 0x15U, 0x88U, 0x21U, 0x52U, 0x08U, 0x40U, 0x05U,	\
			 0xb7U, 0x2aU, 0x8aU, 0x60U, 0x9eU, 0x41U, 0x90U, 0xd7U},
			/* 38158821-5208-4005-b72a-8a609e4190d0 */
		.vcpu_num = 4U,
